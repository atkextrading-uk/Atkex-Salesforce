...
import getAllDivergenceTrades from '@salesforce/apex/DivergenceTradesDataController.getAllDivergenceTrades';

export default class DivergenceTradeSummary extends LightningElement {
    totalProfit;
    numberOpen;
    @track trades;
    @track data;

    DivergenceTradeSummary() {
        
    }

    @wire(getAllDivergenceTrades, {})
    wireData(result) {
        this.trades = result;
        if (result.data) {
