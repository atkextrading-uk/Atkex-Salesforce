...
import getAllTrades from '@salesforce/apex/TechnicalAnalysisTradesDataController.getAllTechnicalAnalysisTradesOpen';
...
export default class TechnicalAnalysisDatatable extends LightningElement {
    columns = columns;
    showSpinner = false;
    @track data = [];
    @track tradeData;
